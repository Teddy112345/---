...
winl = my_font.render("Победила левая рокетка", True, (255, 255, 0))
winr = my_font.render("Победила правая рокетка!", True, (255, 255, 0))
...
while run:
    ...
    if ball.rect.x < 0:
        finish = True
        window.blit(winr, (180, 200))
    if ball.rect.x > 700:
        finish = True
        window.blit(winl, (180, 200))
    display.update() 
    clock.tick(60)
